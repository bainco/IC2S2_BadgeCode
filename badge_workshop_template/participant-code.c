/**
participant-code.c for Workshop
@Author Connor Bain
@Copyright Connor Bain, 2016
...
// Apply your edits to the home page here!

// To invert your screen (replace all black pixels with white pixels)
// invert(1);
// To revert, use invert(0);

// To rotate your screen, use rotate180();
}

// Look for the next workshop workspace in the main() loop!

/*********************************************************/
/*********************************************************/
/*************** END WORSHOP WORKSPACE *******************/
/*********************************************************/
/*********************************************************/
